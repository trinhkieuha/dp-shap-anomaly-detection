...
python3.11 "scripts/dpsgd_model.py" --version 202506081954 --continue_run True --n_calls=70 #Recall----5
#python3.11 "scripts/dpsgd_model.py" --version 202506082214 --continue_run True --n_calls=50 #Recall----3
#python3.11 "scripts/dpsgd_model.py" --version 202506090641 --continue_run True --n_calls=30 #Recall----1
