...
from src.explainability import ShapKernelExplainer, ExplainabilityEvaluator
...
def main():
    ...
    try:
        eval_init = ExplainabilityEvaluator(model_type=model_type, metric=metric, background_method=background_method, continue_run=continue_run)
