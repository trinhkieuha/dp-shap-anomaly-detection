...
#python3.11 "scripts/posthoc_dp_model.py" --version 202505280357 --continue_run True --n_calls=90 #Recall		gaussian
#python3.11 "scripts/posthoc_dp_model.py" --version 202505280515 --continue_run True --n_calls=90 #Recall		laplace	
...
#python3.11 "scripts/posthoc_dp_model.py" --version 202505280043 --continue_run True --n_calls=90 #F1-Score	gaussian
#python3.11 "scripts/posthoc_dp_model.py" --version 202505280204 --continue_run True --n_calls=70 #F1-Score	laplace	
#python3.11 "scripts/posthoc_dp_model.py" --version 202505280115 --continue_run True --n_calls=50 #F1-Score	gaussian
#python3.11 "scripts/posthoc_dp_model.py" --version 202505280233 --continue_run True --n_calls=90 #F1-Score	laplace	
#python3.11 "scripts/posthoc_dp_model.py" --version 202505280137 --continue_run True --n_calls=70 #F1-Score	gaussian
...
#python3.11 "scripts/posthoc_dp_model.py" --version 202505272313 --continue_run True --n_calls=70 #AUC			laplace	
#python3.11 "scripts/posthoc_dp_model.py" --version 202505272225 --continue_run True --n_calls=90 #AUC			gaussian
#python3.11 "scripts/posthoc_dp_model.py" --version 202505272344 --continue_run True --n_calls=50 #AUC			laplace	
#python3.11 "scripts/posthoc_dp_model.py" --version 202505282206 --continue_run True --n_calls=70 #AUC			gaussian
#python3.11 "scripts/posthoc_dp_model.py" --version 202505282139 --continue_run True --n_calls=70 #AUC			laplace	